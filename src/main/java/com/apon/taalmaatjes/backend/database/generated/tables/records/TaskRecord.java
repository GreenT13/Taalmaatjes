...
public class TaskRecord extends UpdatableRecordImpl<TaskRecord> implements Record7<Integer, String, String, String, Integer, Boolean, Boolean> {

    private static final long serialVersionUID = 313700765;
    ...
    /**
     * Setter for <code>PUBLIC.TASK.ISCANCELLED</code>.
     */
    ...
    /**
     * Getter for <code>PUBLIC.TASK.ISCANCELLED</code>.
     */
     ...
     */
    @Override
    public Row7<Integer, String, String, String, Integer, Boolean, Boolean> fieldsRow() {
     ...
     */
    @Override
    public Row7<Integer, String, String, String, Integer, Boolean, Boolean> valuesRow() {
     ...
     */
    @Override
    public TaskRecord values(Integer value1, String value2, String value3, String value4, Integer value5, Boolean value6, Boolean value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TaskRecord(Integer taskid, String externalidentifier, String title, String description, Integer volunteerid, Boolean iscancelled, Boolean isfinished) {
        super(Task.TASK);
